...
<head>
    ...
    <title>Datenschutz | Plänitz-Leddin</title>
...
<body>
    ...
    <div id="main">
        ...
        <section>
            ...
            <p>
                Gemeinsam für Plänitz-Leddin e.V.<br>
                Paul <span class="missing">Nachname</span><br>
                <span class="missing"> Straße</span><br>
                <span class="missing">PLZ Ort</span>
            </p>
            <p>
                <span class="missing">Telefon: </span><br>
                <span class="missing">E-Mail: </span>
            </p>
        </section>
        <section>
        ...
        <section>
            ...
            <h3><span class="numbering">1.</span> Widerruf der Einwilligung</h3>
            <p>
            ...
            <h3><span class="numbering">2.</span> Recht auf Bestätigung</h3>
            <p>
                Sie haben das Recht, von dem Verantwortlichen eine Bestätigung darüber zu verlangen, ob wir sie betreffende personenbezogene Daten verarbeiten. Die Bestätigung können Sie jederzeit unter den oben genannten Kontaktdaten verlangen.
            </p>
            <h3><span class="numbering">3.</span> Auskunftsrecht</h3>
            <p>
            ...
            <h3><span class="numbering">4.</span> Recht auf Berichtigung</h3>
            <p>
                Sie haben das Recht, von uns unverzüglich die Berichtigung Sie betreffender unrichtiger personenbezogener Daten zu verlangen. Unter Berücksichtigung der Zwecke der Verarbeitung haben Sie das Recht, die Vervollständigung unvollständiger personenbezogener Daten – auch mittels einer ergänzenden Erklärung – zu verlangen.
            </p>
            <h3><span class="numbering">5.</span> Recht auf Löschung („Recht auf Vergessen werden")</h3>
            <p>
            ...
            <h3><span class="numbering">6.</span> Recht auf Einschränkung der Verarbeitung</h3>
            <p>
            ...
            <h3><span class="numbering">7.</span> Recht auf Datenübertragbarkeit</h3>
            <p>
            ...
            <h3><span class="numbering">8.</span> Widerspruchsrecht</h3>
            <p>
            ...
            <h3><span class="numbering">9.</span> Automatisierte Entscheidungen im Einzelfall einschließlich Profiling</h3>
            <p>
                Sie haben das Recht, nicht einer ausschließlich auf einer automatisierten Verarbeitung – einschließlich Profiling – beruhenden Entscheidung unterworfen zu werden, die Ihnen gegenüber rechtliche Wirkung entfaltet oder Sie in ähnlicher Weise erheblich beeinträchtigt.
            </p>
            <h3><span class="numbering">10.</span> Recht auf Beschwerde bei einer Aufsichtsbehörde</h3>
            <p>
                Sie haben zudem, unbeschadet eines anderweitigen verwaltungsrechtlichen oder gerichtlichen Rechtsbehelfs, das Recht auf Beschwerde bei einer Aufsichtsbehörde, insbesondere in dem Mitgliedstaat ihres Aufenthaltsorts, ihres Arbeitsplatzes oder des Orts des mutmaßlichen Verstoßes, wenn die betroffene Person der Ansicht ist, dass die Verarbeitung der sie betreffenden personenbezogenen Daten gegen diese Verordnung verstößt.
            </p>
            <h3><span class="numbering">11.</span> Recht auf wirksamen gerichtlichen Rechtsbehelf</h3>
            <p>
                Sie haben unbeschadet eines verfügbaren verwaltungsrechtlichen oder außergerichtlichen Rechtsbehelfs einschließlich des Rechts auf Beschwerde bei einer Aufsichtsbehörde gemäß Artikel 77 DSGVO das Recht auf einen wirksamen gerichtlichen Rechtsbehelf, wenn sie der Ansicht ist, dass die ihr aufgrund dieser Verordnung zustehenden Rechte infolge einer nicht im Einklang mit dieser Verordnung stehenden Verarbeitung ihrer personenbezogenen Daten verletzt wurden.
            </p>
        </section>
        <section>
            <h2>Nutzung der OpenStreetMap Nominatim API</h2>
            <p>
                Auf dieser Website nutzen wir die Nominatim-Geocoding-API von OpenStreetMap, um Koordinaten in lesbare Adressen umzuwandeln. Dies geschieht ausschließlich auf unserer Mitgliedsantrag-Seite, wenn Sie freiwillig Ihre Standortdaten zur Verfügung stellen.
            </p>
            <p>
                <strong>Wichtig:</strong> Die Standortabfrage erfolgt nur, wenn Sie aktiv auf den entsprechenden Button klicken und der Standortfreigabe in Ihrem Browser zustimmen. Ohne Ihre ausdrückliche Einwilligung werden keine Standortdaten erfasst.
            </p>
            
            <h3>Wie funktioniert die Datenverarbeitung?</h3>
            <p>
                Wenn Sie die Standortfunktion nutzen:
            </p>
            <ol>
                <li>Ihr Browser fragt Sie um Erlaubnis zur Standortfreigabe</li>
                <li>Nach Ihrer Zustimmung werden die GPS-Koordinaten an unseren Server übermittelt</li>
                <li>Unser Server leitet diese Koordinaten an die OpenStreetMap Nominatim API weiter</li>
                <li>Die API gibt die zugehörige Adresse zurück</li>
                <li>Diese Adresse wird in Ihr Formular eingefügt</li>
            </ol>
            <h3>Welche Daten werden übertragen?</h3>
            <p>
                An OpenStreetMap werden übermittelt:
            </p>
            <ul>
                <li>Die GPS-Koordinaten (Breitengrad und Längengrad)</li>
                <li>Die IP-Adresse unseres Servers (nicht Ihre persönliche IP-Adresse)</li>
                <li>Der User-Agent unserer Website</li>
            </ul>
            <h3>Datenschutz bei OpenStreetMap</h3>
            <p>
                OpenStreetMap ist ein gemeinnütziges Open-Source-Projekt und unterscheidet sich grundlegend von kommerziellen Kartendiensten:
            </p>
            <ul>
                <li><strong>Keine Nutzerprofile:</strong> OpenStreetMap erstellt keine Nutzerprofile</li>
                <li><strong>Keine Werbung:</strong> Die Daten werden nicht für Werbezwecke genutzt</li>
                <li><strong>Keine langfristige Speicherung:</strong> Anfragen werden nur für technische Logzwecke temporär gespeichert</li>
                <li><strong>Kein Tracking:</strong> Es findet kein Tracking über verschiedene Websites hinweg statt</li>
            </ul>
            <p>
                Die Nutzungsbedingungen von OpenStreetMap finden Sie unter: <a class="numbering" href="https://operations.osmfoundation.org/policies/nominatim/" target="_blank" rel="noopener">https://operations.osmfoundation.org/policies/nominatim/</a>
            </p>
            <p>
                Rechtsgrundlage für die Verarbeitung ist Art. 6 Abs. 1 lit. a DSGVO (Ihre Einwilligung durch aktive Standortfreigabe).
            </p>
        </section>
        <section>
            <h2>Auftragsverarbeiter</h2>
            <p>
                Wir bedienen uns externer Dienstleister (Auftragsverarbeiter) z. B. für den Versand von Informationen oder technische Dienstleistungen. Mit dem Dienstleister wurde eine separate Auftragsverarbeitung geschlossen, um den Schutz Ihrer personenbezogenen Daten zu gewährleisten.
            </p>
            <p>
                Wir arbeiten mit folgenden Dienstleistern zusammen:
            </p>
            <ul>
                <li>1&1 IONOS (Webhosting)</li>
                <li>OpenStreetMap Nominatim API (Geocoding-Dienst)</li>
                <li>GitHub (Code-Hosting)</li>
            </ul>
        </section>
        <section style="margin-top: 40px; padding-top: 20px; border-top: 1px solid var(--lightgrey);">
            <p style="font-size: 0.9em; color: var(--lightgrey);">
